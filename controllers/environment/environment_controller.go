...
// +kubebuilder:rbac:groups=environment.dynatrace.kubeform.com,resources=environments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=environment.dynatrace.kubeform.com,resources=environments/status,verbs=get;update;patch
...
func (r *EnvironmentReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch Environment")
...
func (r *EnvironmentReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &environmentv1alpha1.Environment{}); err != nil {
			klog.Error(err, "unable to set up auditor", environmentv1alpha1.Environment{}.APIVersion, environmentv1alpha1.Environment{}.Kind)
			return err
		}
	}
