...
// +kubebuilder:rbac:groups=host.dynatrace.kubeform.com,resources=namings,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=host.dynatrace.kubeform.com,resources=namings/status,verbs=get;update;patch
...
func (r *NamingReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &hostv1alpha1.Naming{}); err != nil {
			klog.Error(err, "unable to set up auditor", hostv1alpha1.Naming{}.APIVersion, hostv1alpha1.Naming{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&hostv1alpha1.Naming{}).
