...
// +kubebuilder:rbac:groups=span.dynatrace.kubeform.com,resources=attributes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=span.dynatrace.kubeform.com,resources=attributes/status,verbs=get;update;patch
...
func (r *AttributeReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &spanv1alpha1.Attribute{}); err != nil {
			klog.Error(err, "unable to set up auditor", spanv1alpha1.Attribute{}.APIVersion, spanv1alpha1.Attribute{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&spanv1alpha1.Attribute{}).
