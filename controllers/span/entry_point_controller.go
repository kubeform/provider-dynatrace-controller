...
// +kubebuilder:rbac:groups=span.dynatrace.kubeform.com,resources=entrypoints,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=span.dynatrace.kubeform.com,resources=entrypoints/status,verbs=get;update;patch
...
func (r *EntryPointReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch EntryPoint")
...
func (r *EntryPointReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &spanv1alpha1.EntryPoint{}); err != nil {
			klog.Error(err, "unable to set up auditor", spanv1alpha1.EntryPoint{}.APIVersion, spanv1alpha1.EntryPoint{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&spanv1alpha1.EntryPoint{}).
