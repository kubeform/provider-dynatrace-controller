...
// +kubebuilder:rbac:groups=aws.dynatrace.kubeform.com,resources=credentials,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=aws.dynatrace.kubeform.com,resources=credentials/status,verbs=get;update;patch
...
func (r *CredentialsReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &awsv1alpha1.Credentials{}); err != nil {
			klog.Error(err, "unable to set up auditor", awsv1alpha1.Credentials{}.APIVersion, awsv1alpha1.Credentials{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&awsv1alpha1.Credentials{}).
