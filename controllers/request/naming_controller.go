...
func (r *NamingReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &requestv1alpha1.Naming{}); err != nil {
			klog.Error(err, "unable to set up auditor", requestv1alpha1.Naming{}.APIVersion, requestv1alpha1.Naming{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&requestv1alpha1.Naming{}).
