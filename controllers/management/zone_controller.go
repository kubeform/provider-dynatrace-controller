...
// +kubebuilder:rbac:groups=management.dynatrace.kubeform.com,resources=zones,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=management.dynatrace.kubeform.com,resources=zones/status,verbs=get;update;patch
...
func (r *ZoneReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &managementv1alpha1.Zone{}); err != nil {
			klog.Error(err, "unable to set up auditor", managementv1alpha1.Zone{}.APIVersion, managementv1alpha1.Zone{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&managementv1alpha1.Zone{}).
