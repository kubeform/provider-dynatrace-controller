...
// +kubebuilder:rbac:groups=service.dynatrace.kubeform.com,resources=namings,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=service.dynatrace.kubeform.com,resources=namings/status,verbs=get;update;patch
...
func (r *NamingReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &servicev1alpha1.Naming{}); err != nil {
			klog.Error(err, "unable to set up auditor", servicev1alpha1.Naming{}.APIVersion, servicev1alpha1.Naming{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&servicev1alpha1.Naming{}).
