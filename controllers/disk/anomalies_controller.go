...
// +kubebuilder:rbac:groups=disk.dynatrace.kubeform.com,resources=anomalies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=disk.dynatrace.kubeform.com,resources=anomalies/status,verbs=get;update;patch
...
func (r *AnomaliesReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &diskv1alpha1.Anomalies{}); err != nil {
			klog.Error(err, "unable to set up auditor", diskv1alpha1.Anomalies{}.APIVersion, diskv1alpha1.Anomalies{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&diskv1alpha1.Anomalies{}).
