...
// +kubebuilder:rbac:groups=alerting.dynatrace.kubeform.com,resources=profiles,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=alerting.dynatrace.kubeform.com,resources=profiles/status,verbs=get;update;patch
...
func (r *ProfileReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &alertingv1alpha1.Profile{}); err != nil {
			klog.Error(err, "unable to set up auditor", alertingv1alpha1.Profile{}.APIVersion, alertingv1alpha1.Profile{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&alertingv1alpha1.Profile{}).
