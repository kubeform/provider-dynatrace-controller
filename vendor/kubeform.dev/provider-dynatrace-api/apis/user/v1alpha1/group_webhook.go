...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-user-dynatrace-kubeform-com-v1alpha1-group,mutating=false,failurePolicy=fail,groups=user.dynatrace.kubeform.com,resources=groups,versions=v1alpha1,name=group.user.dynatrace.kubeform.io,sideEffects=None,admissionReviewVersions=v1
