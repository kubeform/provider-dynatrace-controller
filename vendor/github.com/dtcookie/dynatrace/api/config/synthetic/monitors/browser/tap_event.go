...
func (me *TapEvent) GetType() EventType {
	return EventTypes.Tap
}

func (me *TapEvent) Schema() map[string]*hcl.Schema {
...
func (me *TapEvent) MarshalHCL() (map[string]interface{}, error) {
...
func (me *TapEvent) UnmarshalHCL(decoder hcl.Decoder) error {
