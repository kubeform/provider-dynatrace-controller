module kubeform.dev/provider-dynatrace-controller

go 1.17

require (
	github.com/dynatrace-oss/terraform-provider-dynatrace v1.10.0
	...
	kubeform.dev/provider-dynatrace-api v0.4.1-0.20220314083752-15f19a0d9101
...
require (
	...
	github.com/dtcookie/dynatrace/api/config/alerting v1.0.20 // indirect
	...
	github.com/dtcookie/dynatrace/api/config/applications/web v1.0.3 // indirect
	github.com/dtcookie/dynatrace/api/config/autotags v1.0.22 // indirect
	github.com/dtcookie/dynatrace/api/config/common v1.0.4 // indirect
	github.com/dtcookie/dynatrace/api/config/credentials/aws v1.0.12 // indirect
	github.com/dtcookie/dynatrace/api/config/credentials/azure v1.0.11 // indirect
	github.com/dtcookie/dynatrace/api/config/credentials/kubernetes v1.0.13 // indirect
	github.com/dtcookie/dynatrace/api/config/credentials/vault v1.0.1 // indirect
	github.com/dtcookie/dynatrace/api/config/customservices v1.0.15 // indirect
	github.com/dtcookie/dynatrace/api/config/dashboards v1.0.15 // indirect
	...
	github.com/dtcookie/dynatrace/api/config/maintenance v1.0.9 // indirect
	github.com/dtcookie/dynatrace/api/config/managementzones v1.0.17 // indirect
	github.com/dtcookie/dynatrace/api/config/metrics/calculated/service v1.0.4 // indirect
	...
	github.com/dtcookie/dynatrace/api/config/synthetic/monitors v1.0.7 // indirect
	github.com/dtcookie/dynatrace/api/config/v2/keyrequests v1.0.0 // indirect
	github.com/dtcookie/dynatrace/api/config/v2/slo v1.0.5 // indirect
	github.com/dtcookie/dynatrace/api/config/v2/spans/attributes v1.0.0 // indirect
	github.com/dtcookie/dynatrace/api/config/v2/spans/capture v1.0.0 // indirect
	github.com/dtcookie/dynatrace/api/config/v2/spans/ctxprop v1.0.0 // indirect
	github.com/dtcookie/dynatrace/api/config/v2/spans/entrypoints v1.0.1 // indirect
	github.com/dtcookie/dynatrace/api/config/v2/spans/match v1.0.1 // indirect
	github.com/dtcookie/dynatrace/api/config/v2/spans/resattr v1.0.1 // indirect
